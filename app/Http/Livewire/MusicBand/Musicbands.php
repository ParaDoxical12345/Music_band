...
class Musicbands extends Component
{
    ...
    public function addBar()
    {
        ...
        session()->flash('message', 'New playlist has been added Successfully');
    ...
    public function updateBarData()
    {
        ...
        session()->flash('edit-info', 'New Playlist has been updated Successfully');
    }
    ...
    public function deleteBardata()
    {
        ...
        session()->flash('delete-info', 'Selection has been deleted Successfully');
